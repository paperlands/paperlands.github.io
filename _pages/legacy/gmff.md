...
<div class="gmff-presenter inline-block">
  <span class="font-display text-sm tracking-[0.3em] text-orange-400 opacity-60 uppercase block">
...
<div class="font-body text-base text-gray-400 leading-relaxed max-w-lg mx-auto font-light tracking-wide space-y-4">
  <p>
...
<section class="gmff-results-wrap w-full">
  {% include legacy/gmff/podium.html %}
</section>
{% include legacy/gmff/podium_assets.html %}

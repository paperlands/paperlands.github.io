...
<section id="cta" class="my-40 lg:my-48">
  <div class="max-w-2xl px-4 mx-auto mt-4 text-center">
    ...
    <p class="mt-6 text-sm text-slate-500">Full 10-week program fee: <span class="font-semibold text-slate-700">USD 800</span>. No obligation to enroll after the trial.</p>
  </div>
</section>

  ...
  <div class="flex flex-col-reverse items-center max-w-6xl px-6 mx-auto lg:flex-row lg:items-start">
    ...
    <div class="flex flex-col lg:w-1/2">
      ...
      <p class="mt-6 text-lg lg:text-xl">
        ...
        <br><br>
        Learning cannot remain isolated in classrooms—it must live in community through discussion, teaching, and collaboration. 
        <br><br>
        The Math Leaders Program develops the student leaders who spark and sustain this culture.
      </p>
    </div>
    <!-- RIGHT (Desktop) / TOP (Mobile): SVG -->
    <div class="w-full max-w-md lg:w-1/2">
      <svg viewBox="0 0 600 600" class="w-full mx-2" role="img" aria-label="MLP: Math, Leadership, Creativity, Service">
        <g fill="none" stroke="#111827" stroke-width="4">
          <circle cx="300" cy="190" r="150" />
          <circle cx="190" cy="300" r="150" />
          <circle cx="410" cy="300" r="150" />
          <circle cx="300" cy="410" r="150" />
        </g>
        <g font-family="'Paperlang', system-ui, sans-serif" text-anchor="middle">
          <text x="300" y="125" font-size="28">Leadership</text>
